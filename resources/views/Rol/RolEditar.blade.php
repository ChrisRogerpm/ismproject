...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">EDITAR ROL </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="form-group">
                                <label for=""><b>NOMBRE DE ROL</b></label>
...
<script>
    Rol = @json($Rol);
    ListaRolPermiso = @json($ListaRolPermiso);

</script>
<script src="{{asset('assets/viewJs/Rol/RolEditar.js')}}"></script>
@endpush
