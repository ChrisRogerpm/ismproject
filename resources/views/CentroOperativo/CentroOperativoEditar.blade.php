...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">EDITAR CENTRO OPERATIVO </h3>
...
@push('js')
<script>
    CentroOperativo = @json($CentroOperativo);

</script>
<script src="{{asset('assets/viewJs/CentroOperativo/CentroOperativoEditar.js')}}"></script>
@endpush
