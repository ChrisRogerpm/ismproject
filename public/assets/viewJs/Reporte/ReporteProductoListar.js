        ...
        CargarTablaDatatable({
            ...
            callBackSuccess: function (response) {
                ...
                if (data != undefined) {
                    ...
                    $("#txtCantidadTotalProductoMasVendido").text(
                        data.cantidad
                    );
                } else {
                    $("#txtNombreProductoMasVendido").text(
            ...
            tablefooterCallback: function (row, tbldata, start, end, display) {
                ...
                $("#MontoTotalProductosVendidos").text(
                    SumaTotalProductosUnidades.toFixed(2)
                );
                $("#txtTotalProductosUnidades").text(
                    SumaTotalProductosUnidades.toFixed(2)
                );
                $("#txtTotalProductosPaquetes").text(
                    SumaTotalProductosPaquetes.toFixed(2)
                );
                $("#MontoTotalProductosPaquete").text(
                    SumaTotalProductosPaquetes.toFixed(2)
                );
